# Jobbr ComponentModel Management

This Repository contains specifications, aka. Component Models for gaining access to [Jobbr](http://www.jobbr.io) though the Server Management API as a plugin.
...
[![NuGet-Stable](https://img.shields.io/nuget/v/Jobbr.ComponentModel.Registration?label=NuGet%20stable)](https://www.nuget.org/packages/Jobbr.ComponentModel.Management)
[![NuGet Pre-Release](https://img.shields.io/nuget/vpre/Jobbr.ComponentModel.Registration?label=NuGet%20pre)](https://www.nuget.org/packages/Jobbr.ComponentModel.Management)
